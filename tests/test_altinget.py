...
class test_Altinget(unittest.TestCase):
    ...
    def test_getNews_altinget(self):
        ...
        try:
            alt_concretenews_building(2).getNews_altinget()
            category = altinget_building.alt_concretenews_building(2).news.category
            headline = altinget_building.alt_concretenews_building(2).news.headline
            content = altinget_building.alt_concretenews_building(2).news.content
            date = altinget_building.alt_concretenews_building(2).news.date
            provider = altinget_building.alt_concretenews_building(2).news.provider
